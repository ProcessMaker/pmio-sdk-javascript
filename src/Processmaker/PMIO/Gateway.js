...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PMIO.Gateway = factory(root.PMIO.ApiClient, root.PMIO.ErrorArray, root.PMIO.GatewayItem, root.PMIO.GatewayCreateItem, root.PMIO.ResultSuccess, root.PMIO.GatewayCollection, root.PMIO.GatewayUpdateItem);
  }
  ...
  /**
   * Gateway service.
   * @module Processmaker/PMIO/Gateway
   * @version 1.0.0
   */

  /**
   * Constructs a new Gateway. 
   * @alias module:Processmaker/PMIO/Gateway
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:Processmaker/PMIO/Gateway~addGatewayCallback
     ...
     * @param {module:Processmaker/PMIO/Gateway~addGatewayCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:Processmaker/PMIO/Gateway~deleteGatewayCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:Processmaker/PMIO/Gateway~deleteGatewayCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:Processmaker/PMIO/Gateway~findGatewayByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:Processmaker/Model/GatewayItem} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:Processmaker/PMIO/Gateway~findGatewayByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Processmaker/Model/GatewayItem}
     */
     ...
     * @callback module:Processmaker/PMIO/Gateway~findGatewaysCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:Processmaker/PMIO/Gateway~findGatewaysCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:Processmaker/PMIO/Gateway~updateGatewayCallback
     * @param {String} error Error message, if any.
     * @param {module:Processmaker/Model/GatewayItem} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:Processmaker/PMIO/Gateway~updateGatewayCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Processmaker/Model/GatewayItem}
     */
