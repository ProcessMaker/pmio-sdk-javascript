...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PMIO.ResultSuccessMeta = factory(root.PMIO.ApiClient);
  }
   ...
   * @module Processmaker/Model/ResultSuccessMeta
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ResultSuccessMeta</code>.
   * @alias module:Processmaker/Model/ResultSuccessMeta
   * @class
   ...
   * @param {module:Processmaker/Model/ResultSuccessMeta} obj Optional instance to populate.
   * @return {module:Processmaker/Model/ResultSuccessMeta} The populated <code>ResultSuccessMeta</code> instance.
   */
