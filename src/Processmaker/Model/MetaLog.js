...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PMIO.MetaLog = factory(root.PMIO.ApiClient);
  }
   ...
   * @module Processmaker/Model/MetaLog
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MetaLog</code>.
   * @alias module:Processmaker/Model/MetaLog
   * @class
   ...
   * @param {module:Processmaker/Model/MetaLog} obj Optional instance to populate.
   * @return {module:Processmaker/Model/MetaLog} The populated <code>MetaLog</code> instance.
   */
