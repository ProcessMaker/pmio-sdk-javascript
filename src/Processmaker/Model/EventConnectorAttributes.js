...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PMIO.EventConnectorAttributes = factory(root.PMIO.ApiClient);
  }
   ...
   * @module Processmaker/Model/EventConnectorAttributes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>EventConnectorAttributes</code>.
   * @alias module:Processmaker/Model/EventConnectorAttributes
   * @class
   */
   ...
   * @param {module:Processmaker/Model/EventConnectorAttributes} obj Optional instance to populate.
   * @return {module:Processmaker/Model/EventConnectorAttributes} The populated <code>EventConnectorAttributes</code> instance.
   */
