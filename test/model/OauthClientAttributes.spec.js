...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PMIO.OauthClientAttributes();
  });
  ...
  describe('OauthClientAttributes', function() {
    it('should create an instance of OauthClientAttributes', function() {
      // uncomment below and update the code to test OauthClientAttributes
      //var instane = new PMIO.OauthClientAttributes();
      //expect(instance).to.be.a(PMIO.OauthClientAttributes);
    });
